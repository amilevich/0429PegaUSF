...
public class BankAppDriver {
	...
	static Logger log = Logger.getLogger(BankAppDriver.class);
				...
				if(f.exists() && !f.isDirectory()) {
					...
					if(jointAccount == true) {
						...
						while(controlJointAccount == 1) {
							...
							File g = new File("C:/Users/Brade/Documents/workspace-sts-3.9.4.RELEASE/BankingAppPt1JT/bankcust/customer" + usernameM + ".ser");
							// If file exists, 
