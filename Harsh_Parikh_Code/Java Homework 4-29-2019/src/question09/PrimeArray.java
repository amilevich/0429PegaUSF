...
public class PrimeArray {
    ...
    public static void main(String[] args) {
    	...
    	// instantiating Array for general list, prime list, and non-prime list
        ArrayList<Integer> myList = new ArrayList<Integer>();
        ArrayList<Integer> myPrimes = new ArrayList<Integer>();
        ArrayList<Integer> notPrimes = new ArrayList<Integer>();
        
        // for each value from 1-100 in general list, iterate each number
        for (int i = 1; i <= 100; i++) {
            myList.add(i);
        }

        System.out.println(myList);
        // for each prime number in the list, use boolean to check prime status.
