...
public class BankApi {
	...
	public void deposit(float amount) {
		...
		System.out.println(firstName.toUpperCase() + " " + lastName.toUpperCase() + " deposited $" + amount
	...
	public void withdraw(float amount) {
		if (balance >= amount) {
			balance = balance - amount;
			lastTransaction = -amount;
			System.out.println(firstName.toUpperCase() + " " + lastName.toUpperCase() + " withdrew $" + amount
					+ ". Current Balance $" + balance);
			...
			try {
				...
				ex.printStackTrace();
				System.out.println("Unable to withdraw " + amount + " for " + firstName.toUpperCase() + " "
						+ lastName.toUpperCase() + " due to insufficient funds.");
			}
