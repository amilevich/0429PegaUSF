...
public class BankApplication {
			...
			while (loggedIn) {
				...
				for (Account acc : myAccounts) {
					if ((acc.firstName.equals(firstName) /* || acc.lastName.equals(lastName) */)
						...
						System.out.println("");
						System.out.println("Welcome To Odunjo Family Credit Union" + "!");
						System.out.println("");
						int choice;
						choice = menu();
						...
						if (choice == 5) {
							System.out.println("End of Transaction. See ya later ;)");
	...
	public static void MainLogin1() {
		System.out.println("Welcome! \nPlease press 1 to login As an Admin/Employee or 2 to login as a Customer");
	}
	...
	public static Account gatheredData(Account data, int choice) throws IOException {
		...
		case 1:
			Scanner sc = new Scanner(System.in);
			System.out.println("How much would you like to deposit? (If you want to deposit $100, enter 100)");
			while (true) {
				try {
		...
		case 2:
			...
			System.out.println("How much would you like to withdraw? (If you want to withdraw $50, enter 50)");
			while (true) {
				try {
	...
	public static void NewAccount() throws IOException {
		...
		System.out.print("Enter Initial Account Deposit Amount: ");
		Amount = one4.nextInt();
	...
	public static void Employee() throws IOException {
		...
		while (true) {
			try {
				...
				System.out.println("Invalid input, Please enter a valid 4 digit numeric pin number for your password (For Example: 1234): ");
			}
		}
		String Anumber = Integer.toString(pin);
		person[2] = Anumber;
		...
		try {
			...
			while ((line = reader.readLine()) != null) {
				...
				System.out.println("These are the batch of account Applications.");
				System.out.println("\nPlease signify whether you 'Approve' or 'Deny' this batch of Applications!");
				System.out.println("\nPlease select 1 to 'Approve' or 2 to 'Deny'");
				...
				if (choiceAdd == 1) {
					...
					String sign = "\nAccount applications have been Denied :'(";
					signBorder(sign);
				}
